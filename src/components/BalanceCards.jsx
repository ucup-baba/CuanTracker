...
const BalanceCards = ({ totalBalance, totalIncome, totalExpense }) => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {/* Saldo Utama */}
            <div className="md:col-span-3 bg-blue-500 border-4 border-black p-8 md:p-12 pop-shadow relative overflow-hidden">
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center">
                    <div>
                        <h2 className="text-xl md:text-2xl font-bold uppercase tracking-widest bg-white inline-block px-4 py-2 border-2 border-black mb-4 pop-shadow-sm">Sisa Amunisi</h2>
            ...
            {/* Total Pemasukan */}
            <div className="bg-green-400 border-4 border-black p-6 pop-shadow flex flex-col justify-between">
            ...
            {/* Total Pengeluaran */}
            <div className="bg-red-400 border-4 border-black p-6 pop-shadow flex flex-col justify-between md:col-span-2">
                <div className="flex justify-between items-center mb-6">
