...
import { getFirestore, collection, addDoc, deleteDoc, doc, setDoc, onSnapshot, query, orderBy } from "firebase/firestore";
...
export { app, analytics, db, auth, googleProvider, collection, addDoc, deleteDoc, doc, setDoc, onSnapshot, query, orderBy, signOut };
